...
const Sidebar: React.FC<SidebarProps> = ({
    ...
    return (
        <aside
            ...
            className={`
fixed top-20 bottom-4 left-4 md:top-24 md:bottom-6 md:left-6 z-[100] transition-all duration-700 ease-[cubic-bezier(0.4,0,0.2,1)] ${isOpen
                    ? 'w-72 translate-x-0 opacity-100'
                    : 'w-72 -translate-x-[calc(100%+24px)] opacity-0 pointer-events-none'
                } flex flex-col`}
        >
